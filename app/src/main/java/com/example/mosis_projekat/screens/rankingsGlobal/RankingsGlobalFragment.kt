package com.example.mosis_projekat.screens.rankingsGlobal
...
class RankingsGlobalFragment : Fragment(),UserRanksListAdapter.UserClickInterface {
    ...
    override fun onCreateView(
        ...
        viewModel.getRanks()
        return inflater.inflate(R.layout.fragment_rankings_global, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val recyclerWorkshops = view.findViewById<RecyclerView>(R.id.recyclerUsers)
        viewModel.globalRanks.observe(viewLifecycleOwner){
